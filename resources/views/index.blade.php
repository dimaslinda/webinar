...
<head>
    ...
    <title>Bootcamp Market Hacking with AI</title>
    ...
    <meta name="twitter:title" content="Bootcamp Market Hacking with AI">
    <meta name="twitter:description"
        content="Bootcamp Market Hacking with AI adalah program intensif 3 minggu yang dirancang untuk memacu skill dan pengetahuan AI di pasar digital.">
    ...
    @php
        $schema = [
            ...
            '@type' => 'Event',
            'name' => 'Bootcamp Market Hacking with AI',
            ...
            'description' =>
                'Bootcamp Market Hacking with AI adalah program intensif 3 minggu yang dirancang untuk memacu skill dan pengetahuan AI di pasar digital. Cocok untuk pebisnis, startup, digital marketer, dan siapa saja yang ingin scale bisnis dengan AI.',
        ...
        <div class="container mx-auto p-6 py-20">
            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="flex flex-col md:flex-row items-center justify-center gap-5 mb-5">
                    <div
                        class="flex gap-2 cursor-pointer text-center items-center py-1.5 px-5 rounded-full bg-white capitalize font-semibold transition-all duration-300 ease-in-out hover:bg-secondary hover:text-white hover:scale-105 hover:shadow-xl group">
                        ...
                        kamis - jumat, <br> 28 - 29 agustus 2025
                ...
                <div class="flex flex-col md:flex-row justify-between gap-4 w-full max-w-6xl my-5">
                    ...
                    <a href="https://maps.app.goo.gl/XW31PiDGbJTrLzac9" target="_blank"
                        class="px-5 w-full flex flex-col items-center justify-center text-center">
                        <div class="text-white text=base md:text-xl lg:text-2xl italic font-normal">
                            kelas offline
                        </div>
                        <div class="text-white text=base md:text-xl lg:text-2xl italic font-semibold">
                            Digital Bootcamp Inovasika
                        </div>
                    </a>
                </div>
                ...
                <div class="relative flex flex-col items-center md:flex-row gap-8 w-full justify-center z-10">
                    ...
                    <div
                        ...
                        <div class="flex items-center text-base font-extrabold mb-4 gap-2">
                            ...
                            <span class="text-white">09.00 - 12.00 WIB</span>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center text-base font-extrabold mb-4 gap-2">
                            ...
                            <span class="text-white">13.00 – 16.00 WIB</span>
                        </div>
                        <ul class="list-disc text-white text-sm space-y-1">
            ...
            <div class="flex flex-col item-center xl:flex-row">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="text-white text-base">
                            Penawaran Eksklusif <br> Bootcamp Inovasika
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col lg:flex-row">
                <div class="flex-1">
                    <div class="text-secondary text-4xl md:text-5xl lg:text-7xl 2xl:text-8xl capitalize font-bold">
                        untuk <span class="text-white bg-primary font-bold leading-snug px-2">siapa</span> Bootcamp
                        ini?
                    </div>
                    <div class="mt-10">
                ...
                <div class="flex flex-col items-center mt-8">
                    <div class="w-full max-w-4xl">
                        <div
                            ...
                            <a href="https://maps.app.goo.gl/XW31PiDGbJTrLzac9" target="_blank"
                                class="flex-1 flex flex-col items-center text-center md:pl-8">
                                <span class="text-white text-sm md:text-xl italic capitalize">
                                    kelas offline
                                </span>
                                <span class="text-white text-lg md:text-2xl font-bold italic mt-1">
                                    digital bootcamp
                                    inovasika
                                </span>
                            </a>
